...
function setEnabledLayers(n,varargin)

isTimeZero = varargin{1};
headOn = varargin{2};
...
function updateNet(n,isTimeZero)
normalise = ~isTimeZero;
n.hidden.normalise = normalise;
n.retinal.normalise = normalise;
n.eye.normalise = normalise;
n.head.normalise = normalise;
